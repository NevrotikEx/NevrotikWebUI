        ...
        with gr.Row().style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train"):
                    ...
                    training_width = gr.Slider(minimum=512, maximum=512, step=64, label="Width", value=512)
                    training_height = gr.Slider(minimum=512, maximum=512, step=64, label="Height", value=512)
